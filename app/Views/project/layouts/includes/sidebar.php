        ...
        <div class="user-panel">
            ...
            <?php
                if (!empty(session("foto"))) {
                    ...
                    echo '<img src="uploads/' . session("foto") . '" class="img-circle" alt="User Image">';
                } else {
                    echo '<img src="' . base_url("app/img/template/user/anonymous.png") . '" class="img-circle" alt="User Image">';
                }
            ?>
            </div>
